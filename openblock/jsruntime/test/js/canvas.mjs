...
class OBCanvas2D {
    ...
    install(script) {
        script.InstallLib("canvas2d", "canvas2d", [
            script.NativeUtil.fieldSetter(this.canvas2dctx, 'globalCompositeOperation', 'StringRegister'),
            ...
            script.NativeUtil.closureVoid(this.canvas2dctx.arc.bind(this.canvas2dctx), ['DoubleRegister', 'DoubleRegister', 'DoubleRegister', 'DoubleRegister', 'DoubleRegister','LongRegister']),
