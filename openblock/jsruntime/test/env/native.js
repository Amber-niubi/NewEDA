 ...
 */
OpenBlock.Env.registerEvents(['web'], '', [
...
OpenBlock.Env.registerEvents(['web', 'web3d', 'wxmp'], '', [
    { "name": "animationframe" },
    { "name": "windowResize" },
]);
OpenBlock.Env.registerNativeTypes(['web', 'wxmp'], { 'Vector2': [], 'Image': [], 'ImageFile': [] });
OpenBlock.Env.registerNativeFunction(['web', 'wxmp'], 'canvas2d', 'canvas2d', [
    { method_name: 'Canvas2d_globalCompositeOperation', arguments: [{ type: 'String', name: 'type' }], returnType: 'void' },
    ...
    { method_name: 'Canvas2d_setFont', arguments: [{ type: 'String', name: 'font', provider: { type: 'String', value: "30px sans-serif" } }], returnType: 'void' },
    ...
    { method_name: 'Canvas2d_setTextAlign', arguments: [{ type: 'String', name: 'align', provider: { type: 'dropdown', property: Blockly.Msg['Canvas2d_setTextAlign_options'] } }], returnType: 'void' },
    { method_name: 'Canvas2d_getTextAlign', arguments: [], returnType: 'String' },
    { method_name: 'Canvas2d_setTextBaseline', arguments: [{ type: 'String', name: 'align', provider: { type: 'dropdown', property: Blockly.Msg['Canvas2d_setTextBaseline_options'] } }], returnType: 'void' },
    ...
    { method_name: 'Canvas2d_getLineWidth', arguments: [], returnType: 'Number' },
    {
        method_name: 'Canvas2d_drawImage', arguments: [
            { name: 'imageFileName', type: 'String', provider: { type: 'file', mediaType: 'image' } },
    ...
    { method_name: 'Canvas2d_setLineCap', arguments: [{ type: 'String', name: 'lineCap', provider: { type: 'dropdown', property: Blockly.Msg['Canvas2d_setLineCap_options'] } }], returnType: 'void' },
    { method_name: 'Canvas2d_getLineCap', arguments: [], returnType: 'String' },
    {
        method_name: 'Canvas2d_doublePropertyOfCanvas', order: -1, arguments: [
            { type: 'String', name: 'propertyName', provider: { type: "dropdown", property: Blockly.Msg['Canvas2d_doublePropertyOfCanvas_options'] } }
        ], returnType: 'Number'
    },
...
OpenBlock.Env.registerNativeTypes(['web', 'web3d', 'wxmp'], { 'Network_target': [], });
OpenBlock.Env.registerNativeFunction(['web', 'web3d', 'wxmp'], 'network', 'network', [
    ...
    { method_name: 'Network_send_message', arguments: [{ type: 'Network_target', name: 'target' }, { type: 'String', name: 'message_title' }, { type: 'any', name: 'data' }], returnType: 'void' },
    { method_name: 'Network_is_network_message', arguments: [], returnType: 'Boolean' }
]);

OpenBlock.Env.registerNativeTypes(['web', 'web3d', 'wxmp'], {
    'Float32Array': [],
});
OpenBlock.Env.registerNativeTypes(['web', 'web3d', 'wxmp'], {
    'WebAudio_AudioFile': [],
...
OpenBlock.Env.registerNativeFunction(['web', 'web3d', 'wxmp'], 'WebAudio', 'WebAudio', [
    // simple
    { method_name: 'WebAudio_playAudio', arguments: [{ type: 'String', name: 'name', provider: { type: 'file', mediaType: 'sound' } }], returnType: 'void' },
    { method_name: 'WebAudio_createSimpleAudio', arguments: [{ type: 'String', name: 'name', provider: { type: 'file', mediaType: 'sound' } }], returnType: 'WebAudio_SimpleAudio' },
    ...
    { method_name: 'WebAudio_onended', arguments: [{ type: 'WebAudio_SimpleAudio', name: 'audio' }, { type: 'String', name: 'message_title' }], returnType: 'void' },
]);

OpenBlock.Env.registerNativeFunction(['web', 'web3d'], 'WebAudio_advanced', 'WebAudio_advanced', [
    // advanced
    ...
    },
    {
        method_name: 'WebAudio_ScheduledSourceSetOnendMsgTitle', arguments:
            [{ type: 'WebAudio_AudioScheduledSourceNode', name: 'param' }, { type: 'String', name: 'message_title' }],
        returnType: 'void'
    },
    {
...
OpenBlock.Env.registerNativeTypes(['web', 'web3d'], { 'ArrayBuffer': [] });
OpenBlock.Env.registerNativeFunction(['web', 'web3d'], 'sys_file', 'sys_file', [
    {
        method_name: 'sys_file_select_open_as_string', arguments:
            [{ type: 'String', name: 'extensions' }, { type: 'String', name: 'message_title' }], returnType: 'void'
    },
    {
...
OpenBlock.Env.registerNativeFunction(['web', 'web3d', 'wxmp'], 'sys_io', 'sys_io', [
    {
        method_name: 'sys_io_prompt', arguments:
            [{ type: 'String', name: 'question' }, { type: 'String', name: 'message_title' }], returnType: 'void'
    },
]);
OpenBlock.Env.registerNativeFunction(['web', 'web3d'], 'sys_window', 'sys_window', [
    {
...
OpenBlock.Env.registerNativeTypes(['web', 'web3d', 'wxmp'], { 'Date': [] });
OpenBlock.Env.registerNativeFunction(['web', 'web3d', 'wxmp'], 'sys_time', 'sys_time', [
    {
...
OpenBlock.Env.registerNativeFunction(['web', 'web3d', 'wxmp', 'VUE'], 'codePoint', 'codePoint', [
    { method_name: 'codePointAt', arguments: [{ type: 'String', name: 'String' }, { type: 'Integer', name: 'index' }], returnType: 'Integer' },
    { method_name: 'fromCodePoint', arguments: [{ type: 'Integer', name: 'Number' }], returnType: 'String' },
    { method_name: 'fromCodePoint_a', arguments: [{ type: 'list<Integer>', name: 'Number' }], returnType: 'String' },
    { method_name: 'codePointOfString', arguments: [{ type: 'String', name: 'String' }], returnType: 'list<Integer>' },
]);

OpenBlock.Env.registerNativeFunction(['web', 'web3d', 'wxmp', 'VUE'], 'text', 'text', [
    {
        method_name: 'IntegerToTextByRadix', arguments: [
            { type: 'Integer', name: 'radix', provider: { type: 'Integer', value: 2 } },
            { type: 'Number', name: 'value' }
        ], returnType: 'String'
    },
    {
        method_name: 'readStringFromFile', arguments: [
            { type: 'String', name: 'filename', provider: { type: 'file', mediaType: 'text' } }
        ], returnType: 'String'
    },
    {
        method_name: 'String_split', arguments: [
            { type: 'String', name: 'separator', provider: { type: 'String', value: ',' } },
