...
class B_FSMSendMsgWait extends Instruct {
    ...
    waitSecond; typeNameIdx;
    constructor(block, ctx, fCtx, waitSecond, typeNameIdx) {
        super(block, ctx, fCtx);
        this.waitSecond = waitSecond;
        this.typeNameIdx = typeNameIdx;
    }
    toU32() {
        return this.constructor.CODE | (this.waitSecond.i << 17) | this.typeNameIdx;
    }
}
...
class B_ENVREF extends Instruct {
    static CODE = Instruct.CODE(84);
    str;
    register;
    constructor(block, ctx, fCtx, str, r) {
        super(block, ctx, fCtx);
...
class B_FSMSendMessageIntervalToSelf extends Instruct {
    static CODE = Instruct.CODE(85);
    title; Millisecond;
    constructor(block, ctx, fCtx, title, Millisecond) {
        super(block, ctx, fCtx);
        this.title = title;
