...
class LinkContext {
    ...
    nativeFuncMap = {};
    entryFSMName;
    constructor(compiledLibs, data, nativeFuncMap, entryFSMName) {
        this.compiledLibs = compiledLibs;
        this.structData = data;
        this.nativeFuncMap = nativeFuncMap;
        this.entryFSMName = entryFSMName || '';
    }
    ...
    collInfo() {
        ...
        this.addRelocationString(this.entryFSMName || '');
    ...
    makeHeaderBin() {
        ...
        let entryFSMIdx = this.relocation.string[this.entryFSMName].idx;
        header32.push(entryFSMIdx);
    ...
    link() {
        if (typeof (this.entryFSMName) == 'undefined') {
            this.entryFSMName = '';
        }
...
self.onmessage = function (msg) {
    ...
    let link = new LinkContext(compiledLibs, data, request.nativeFuncMap, request.entryFSMName);
    let u32 = link.link();
